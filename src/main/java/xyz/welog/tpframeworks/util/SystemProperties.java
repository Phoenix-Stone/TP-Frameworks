package xyz.welog.tpframeworks.util;
...
import xyz.welog.tpframeworks.util.SystemProperties;

public class SystemProperties extends PropertyPlaceholderConfigurer{
	private static Properties properties = new Properties();
	private Resource[] resources; 
	
	private static SystemProperties systemPropertiesInstence;
	
	/**
	 * 创建实例对象
	 */
	public SystemProperties() {
		if (systemPropertiesInstence == null) {  
			systemPropertiesInstence = this;
		}  
	}
	...
	public static SystemProperties getInstance() {  
       return systemPropertiesInstence;  
	}
